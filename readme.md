...
### Ответ
Сымитируем данную ситуацию. Выполним yes > ~/yes и если нельзя прерывать или преводить в фон, то выполним в другом термиала rm ~/yes далее проверить lsof, что файл 
...
В man set говорится об игнорировании set -e в некоторых случаях в том числе при использовании AND.
В случае если нет необходимости завершать скрипт или выходить из оболочки использование && оправдано.
